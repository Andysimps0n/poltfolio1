  ...
  return (
    <div className="project-explain-container">
      ...
      <div className="project-explain-wrapper">
        ...
        {isReadMore ? 
          <div className="project-explain">be completed in the Bjørvika area. It is built on piles in the Oslo fjord, abutting reclaimed land that extends Oslo's harbor, giving more of the city's waterfront space back to the public.</div>
